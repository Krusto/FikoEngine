...
namespace FikoEngine {
    ...
    void OpenGLShader::Reload(bool forceCompile) {
        std::string vertexSource = ReadShaderFromFile(std::filesystem::path(m_AssetPath).append(m_Name).string(), ShaderType::Vertex);
        std::string fragmentSource = ReadShaderFromFile(std::filesystem::path(m_AssetPath).append(m_Name).string(), ShaderType::Fragment);
