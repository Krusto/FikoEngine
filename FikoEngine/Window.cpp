...
namespace FikoEngine {
        ...
        void Window::SetWidth(const unsigned int& width)
        {
            ...
            {
                glfwSetWindowSizeLimits(m_Window, m_WindowMinimumWidth, m_WindowMinimumHeight, m_WindowData.Width, m_WindowMaximumHeight);
                glfwSetWindowSize(m_Window, m_WindowData.Width, m_WindowData.Height);
            }
            else if (m_WindowData.Width < m_WindowMinimumWidth)
            {
                glfwSetWindowSizeLimits(m_Window, m_WindowData.Width, m_WindowMinimumHeight, m_WindowMaximumWidth, m_WindowMaximumHeight);
                glfwSetWindowSize(m_Window, m_WindowData.Width, m_WindowData.Height);
            }
            else
            {
        ...
        void Window::SetHeight(const unsigned int& height)
        {
            ...
            {
                glfwSetWindowSizeLimits(m_Window, m_WindowMinimumWidth, m_WindowMinimumHeight, m_WindowMaximumWidth, m_WindowData.Height);
                glfwSetWindowSize(m_Window, m_WindowData.Width, m_WindowData.Height);
            }
            else if (m_WindowData.Height < m_WindowMinimumHeight)
            {
                glfwSetWindowSizeLimits(m_Window, m_WindowMinimumWidth, m_WindowData.Height, m_WindowMaximumWidth, m_WindowMaximumHeight);
                glfwSetWindowSize(m_Window, m_WindowData.Width, m_WindowData.Height);
            }
            else
            {
        ...
        void Window::SetSizeLimit(const unsigned int& minWidth, const unsigned int& minHeight, const unsigned int& maxWidth, const unsigned int& maxHeight)
        {
