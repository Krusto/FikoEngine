...
Object ObjectLoader::processMesh(Ref<Material> material, aiMesh* mesh, const aiScene* scene) {
    ...
    if (mesh->mMaterialIndex >= 0)
    {
        ...
        Ref<Material> outMaterial = material;
...
void ObjectLoader::processNode(Ref<Material> material, std::unordered_map<std::string, Object>& meshes, aiNode* node, const aiScene* scene) {
...
std::unordered_map<std::string, Object> ObjectLoader::Load(std::string Path, Ref<Material> material)
{
