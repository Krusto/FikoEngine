...
void InspectorPanel::OnImGUIRender(Entity selectedEntity)
{
    ImGui::Begin("Inspector"); {
        ...
        if (selectedEntity.IsValid()) {
                ...
                if (ImGui::BeginMenu("Add")) {
                    ...
                    if (ImGui::MenuItem("Add Mesh")) {
                        if (!selectedEntity.HasComponent<MeshComponent>())
                            selectedEntity.AddComponent<MeshComponent>().GetComponent<MeshComponent>() = MeshComponent::Generate(selectedEntity,MeshType::None);
                    }
            ...
            if (selectedEntity.HasComponent<TransformComponent>()) {
                ImGui::Separator();
                 opened = ImGui::TreeNodeEx("Transform Component", ImGuiTreeNodeFlags_OpenOnArrow | ImGuiTreeNodeFlags_DefaultOpen);
                ...
                if (opened) {
                    ComponentView::ShowProperties(selectedEntity, selectedEntity.GetComponent<TransformComponent>());
                    ImGui::TreePop();
                }
                if (deleted) {
            ...
            if (selectedEntity.HasComponent<MaterialComponent>()) {
                ImGui::Separator();
                opened = ImGui::TreeNodeEx("Material Component", ImGuiTreeNodeFlags_OpenOnArrow | ImGuiTreeNodeFlags_DefaultOpen);
                if (ImGui::BeginPopupContextItem())
                {
                    if (ImGui::MenuItem("Delete"))
                        deleted = true;
            ...
            if (selectedEntity.HasComponent<CameraComponent>()) {
                ImGui::Separator();
                opened = ImGui::TreeNodeEx("Camera Component", ImGuiTreeNodeFlags_OpenOnArrow | ImGuiTreeNodeFlags_DefaultOpen);
                if (ImGui::BeginPopupContextItem())
                {
                    if (ImGui::MenuItem("Delete"))
                        deleted = true;
            ...
            if (selectedEntity.HasComponent<MeshComponent>()) {
                opened = ImGui::TreeNodeEx("Mesh Component", ImGuiTreeNodeFlags_OpenOnArrow | ImGuiTreeNodeFlags_DefaultOpen);
                if (ImGui::BeginPopupContextItem())
                {
                    if (ImGui::MenuItem("Delete"))
                        deleted = true;
