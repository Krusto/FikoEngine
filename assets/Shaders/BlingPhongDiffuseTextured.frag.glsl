...
void main()
{
    ...
    vec3 ambient = (light.ambient + material.ambient) * vec3(texture(diffuseTexture, vertexData.texCoord));
    ...
    // specular color
    vec3 specular =  light.specular * (spec * (vec3(1.0) - material.specular);  
